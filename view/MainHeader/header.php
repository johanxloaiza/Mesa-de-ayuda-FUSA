<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" class="site-logo">
            <img class="hidden-md-down" src="../../public/img/Logo3.png" alt="">
            <img class="hidden-lg-up" src="../../public/img/Logo3.png" alt="">
        </a>
        ...
        <div class="site-header-content">
            <div class="site-header-content-in">
                ...
                <div class="dropdown dropdown-typical">
                    ...
                    <class="lblcontactonomx"><?php echo $_SESSION["usu_nom"] ?> <?php echo $_SESSION["usu_ape"] ?></span> 
                    </a>
                </div>
